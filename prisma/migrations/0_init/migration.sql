...
-- AddForeignKey
ALTER TABLE "table_assignment" ADD CONSTRAINT "table_assignment_wait_staff_id_fkey" FOREIGN KEY ("wait_staff_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
